...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  onMicrophoneHotkeyPressed: (callback) => {
    ipcRenderer.removeAllListeners('microphone-hotkey-pressed');
    ipcRenderer.on('microphone-hotkey-pressed', () => {
      console.log('[Preload] Received microphone-hotkey-pressed');
      callback();
    });
  },
  ...
  onMicrophoneCodingHotkeyPressed: (callback) => {
    ipcRenderer.removeAllListeners('microphone-coding-hotkey-pressed');
    ipcRenderer.on('microphone-coding-hotkey-pressed', () => {
      console.log('[Preload] Received microphone-coding-hotkey-pressed');
      callback();
    });
  },
